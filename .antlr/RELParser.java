...
public class RELParser extends Parser {
	...
	public static final int
		...
		BETWEEN=27, IN=28, NOT_IN=29, NOT=30, DOUBLE_NOT=31, PLUS=32, MINUS=33, 
		MULTIPLY=34, DIVIDE=35, MODULO=36, COMMA=37, DOT=38, SEMICOLON=39, LPAREN=40, 
		RPAREN=41, LBRACKET=42, RBRACKET=43, LBRACE=44, RBRACE=45, NUMBER=46, 
		STRING=47, BOOLEAN=48, IDENTIFIER=49, WS=50, LINE_COMMENT=51, BLOCK_COMMENT=52;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, "'between'", "'in'", "'not in'", null, "'!!'", null, 
			null, null, null, null, "','", "'.'", "';'", "'('", "')'", "'['", "']'", 
			"'{'", "'}'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SNEQ", "GT", "GTE", "LT", "LTE", "BETWEEN", "IN", "NOT_IN", "NOT", "DOUBLE_NOT", 
			"PLUS", "MINUS", "MULTIPLY", "DIVIDE", "MODULO", "COMMA", "DOT", "SEMICOLON", 
			"LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", "NUMBER", 
			"STRING", "BOOLEAN", "IDENTIFIER", "WS", "LINE_COMMENT", "BLOCK_COMMENT"
		};
	}
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1061031942045694L) != 0)) {
				{
				setState(216);
				conditionalExpression();
				setState(221);
